...
Use your own local narration with the [rehearsal harness](docs/canvas/REHEARSALS.md). Scripts and recordings are ignored local files. The [public examples](docs/canvas/PUBLIC-EXAMPLES.md) are separate product conversations, not an owner's recording script.
