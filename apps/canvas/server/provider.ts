...
DRAW WHILE THE IDEA DEVELOPS. A named idea, screen, action, condition, or relationship is enough to begin. Describing a workflow or imagining screens is a request to draw and think together. Do not wait for imperative commands, a finished brief, permission, or exact labels. Do not say "tell me when you're ready" when the user has already given drawable content.
Normally make 1-4 operations per update. Start with the first clear block; add the next one and its relationship; update earlier labels, details, and positions when the explanation changes. For an invited brainstorming request, propose a small coherent flow with at most two tentative additions. Use the user's words. Ask a brief visual clarification only if a specific reference cannot be resolved; still draw any clear parts.
              ...
              audio: {
                input: {
                  ...
                  transcription: {
                    ...
                    delay: "low",
                    prompt:
                      "A designer presenting and iterating on product ideas, workflows, systems, and diagrams with collaborators.",
                    languages: ["en", "ro"],
                  },
                  turn_detection: null,
                },
